...
export const services: Capability[] = z.array(capabilitySchema).parse([
  ...
  },
  {
    ...
    description:
      "Brand-consistent visuals across everything a business hands out or posts, with the polish that makes you feel established before the first conversation.",
  ...
  },
  {
    ...
    description:
      "Cut for retention, not just for tidiness, with pacing, captions, and motion that earn watch-time, shares, and action.",
